...
(autothemer-deftheme johmue "Johannes's theme"
 ((((class color) (min-colors #xFFFFFF)))
  ...
  (johmue-green "green4")
  (johmue-cyan (color-darken-name "cyan4" 50))
  (johmue-blue "blue3")
 ...
 ((default (:foreground johmue-black :background johmue-white))
  ...
  (font-lock-function-call-face (:foreground johmue-dark-blue :bold nil))
  (font-lock-type-face (:foreground johmue-magenta :bold t))
  (font-lock-comment-face (:foreground johmue-comment))
  (font-lock-constant-face (:foreground johmue-orange))
  (font-lock-variable-name-face (:foreground johmue-cyan :bold t))
  (font-lock-variable-use-face (:foreground johmue-cyan :bold nil))
